...
function (_CloudinaryComponent) {
  ...
  function Image(props, context) {
    ...
    _this.state = {};
    _this.element = _this.props.imageRef || _react["default"].createRef();
    var state = {
      responsive: false,
      url: undefined,
  ...
  _createClass(Image, [{
    ...
    value: function componentDidMount() {
      console.log(this.element); // now that we have a this.element, we need to calculate the URL
    ...
    value: function render() {
      var _CloudinaryComponent$ = _CloudinaryComponent2["default"].normalizeOptions(this.props, this.getContext()),
          ...
          imageRef = _CloudinaryComponent$.imageRef,
          options = _objectWithoutProperties(_CloudinaryComponent$, ["publicId", "responsive", "responsiveDebounce", "children", "imageRef"]);
